      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {[
                { title: "Grafana", href: "https://grafana.healops.online", icon: BarChart3, color: "text-emerald-400" },
                { title: "Prometheus", href: "https://prometheus.healops.online", icon: Activity, color: "text-orange-400" },
                { title: "Jaeger", href: "https://jaeger.healops.online", icon: Search, color: "text-sky-400" },
                { title: "BullMQ", href: "https://bullmq.healops.online", icon: ListTodo, color: "text-violet-400" },
                { title: "Swagger", href: "https://swagger.healops.online", icon: FileCode, color: "text-cyan-400" },
                { title: "Metrics", href: "https://metrics.healops.online", icon: Database, color: "text-amber-400" },
              ].map((item) => (
