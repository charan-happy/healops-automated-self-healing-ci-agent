...
const config: Config = {
  ...
  transformIgnorePatterns: ['node_modules/(?!.*(@octokit|before-after-hook|universal-user-agent|universal-github-app-jwt|@redis|cache-manager-redis-store)/)'],
  moduleNameMapper: {
    ...
    '^@ai/(.*)$': '<rootDir>/ai/$1',
    '^@schema/(.*)$': '<rootDir>/db/schema/$1',
    '^@github-webhook/(.*)$': '<rootDir>/github-webhook/$1',
    '^@repair-jobs/(.*)$': '<rootDir>/repair-jobs/$1',
    '^@repair-agent/(.*)$': '<rootDir>/repair-agent/$1',
    '^@github/(.*)$': '<rootDir>/github/$1',
    '^@validator/(.*)$': '<rootDir>/validator/$1',
    '^@slack/(.*)$': '<rootDir>/slack/$1',
    '^@vector-memory/(.*)$': '<rootDir>/vector-memory/$1',
    '^@cost-tracking/(.*)$': '<rootDir>/cost-tracking/$1',
  },
};
