// @ts-nocheck — auto-generated by drizzle-kit introspect, not used at runtime
...
export const jobs = pgTable("jobs", {
	...
	index("idx_jobs_status_created").using("btree", table.status.asc().nullsLast().op("text_ops"), table.createdAt.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const vectorMemory = pgTable("vector_memory", {
	...
	index("idx_vector_memory_repo_lang_type").using("btree", table.repositoryId.asc().nullsLast().op("uuid_ops"), table.language.asc().nullsLast().op("text_ops"), table.failureType.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.repositoryId],
			foreignColumns: [repositories.id],
