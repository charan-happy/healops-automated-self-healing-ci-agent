        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-6">
          ...
          {reposLoading ? (
            ...
            <p className="py-8 text-center text-sm text-muted-foreground">
              No repositories found. Check your access token permissions.
            </p>
          ) : (
            <>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setConfigFields((f) => ({ ...f, installationId: e.target.value }))}
                  ...
                  />
                  <p className="mt-1 text-xs text-muted-foreground">
                    Find this in the URL after installing the GitHub App (e.g. installations/<strong>12345678</strong>)
                  </p>
                </div>
                <div className="flex justify-end gap-3">
                  ...
                  <button
                    ...
                    disabled={saving || !configFields.installationId}
